...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto shadow-lg border-r-2 border-gray-200">
        <ul class="space-y-2 font-medium">
            ...
            <li class="rounded-lg">
                <a href="" class="{{Route::is('admin.dashboard.statistic') ? 'bg-gray-300' : 'bg-gray-100'}} hover:bg-gray-300 hover:shadow flex items-center p-2 text-gray-800 rounded-lg group">
                <span class="material-symbols-outlined">
                        scatter_plot
                    </span>
            ...
            <li class="rounded-lg">
                <a  class="{{Route::is('organizer.events.index') ? 'bg-gray-300' : 'bg-gray-100'}}  hover:bg-gray-300 hover:shadow flex items-center p-2 text-gray-900 rounded-lg group">
                    <span class="material-symbols-outlined">
                        scatter_plot
                    </span>
