        ...
        <section>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right ">
                    ...
                    <tr class="">
                        <th scope="row" class="">
                            <img src="https://imgs.search.brave.com/zCQiC13v0v6Rp8Vc5CxuoMGNGNFvHrXxHUsj_yg-zxw/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/ZnJlZS1wc2QvM2Qt/cmVuZGVyaW5nLWF2/YXRhcl8yMy0yMTUw/ODMzNTQ2LmpwZz9z/aXplPTYyNiZleHQ9/anBn" style="width: 90px; height: 80px ; border-radius: 50%; margin: 0 auto ; display: block" alt="avatar">
                        </th>
                        <td class="px-6 py-4">
                            {{$user->name}}
                        </td>
